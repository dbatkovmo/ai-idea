...
from app.api.v1.routes import admin_collectors, backtests, health, matches, model_stats, odds_movement, value_bets
...
api_router.include_router(admin_collectors.router, prefix="/admin", tags=["admin collectors"])
